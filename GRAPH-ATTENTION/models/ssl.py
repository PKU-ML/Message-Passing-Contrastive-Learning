...
class SimCLR(BaseSSL):
    ...
    def add_model_hparams(cls, parser):
        # loss params
        parser.add_argument('--temperature', default=0.7, type=float, help='Temperature in the NTXent loss')
        # data params
    ...
    def train_step(self, batch, it=None,cur_iter=0,d_ratio=0):
        logs = self.step(batch,cur_iter,d_ratio)
